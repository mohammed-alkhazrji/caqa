...
#############################################################################
{
    ...
    "assets": {
        "web.assets_backend": [
            "code_backend_theme/static/src/scss/caqa_variables.scss",
            "code_backend_theme/static/src/xml/settings_templates.xml",
            "code_backend_theme/static/src/xml/top_bar_templates.xml",
            "code_backend_theme/static/src/scss/app_launcher.scss",
            "code_backend_theme/static/src/scss/backend_components.scss",
            "code_backend_theme/static/src/scss/views_refine.scss",
